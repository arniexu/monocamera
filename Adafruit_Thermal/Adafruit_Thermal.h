...
class Adafruit_Thermal : public Serial {  //inheritate from class Serial instead of class Print

 public:

  // IMPORTANT: constructor syntax has changed from prior versions
  // of this library.  Please see notes in the example code!
  Adafruit_Thermal(PinName tx, PinName rx, int baud,uint8_t dtr=255); // TODO:
  ...
  void
    ...
    printBitmap(int w, int h, const uint8_t *bitmap, bool fromProgMem=true), // TODO:
    printBitmap(int w, int h, uint8_t *bitmap),  // TODO:
    printBitmap(const char *file),// TODO:
    normal(),
    reset(),
 ...
 private:
  ...
  void
    ...
    writePrintMode();
  	uint8_t toupper(uint8_t c); // TODO:
};
